...
<body>
    <div class="container mt-3">
        <div class="row">
            <div class="col-sm-4">
                <ul class="list-group">
                    <li class="list-group-item"><a href="{{ url('/') }}" class="btn btn-secondary">Back To Side</a></li>
                    <li class="list-group-item"><a href="{{ route('dashboard') }}" class="btn btn-primary">Dashboard</a></li>
